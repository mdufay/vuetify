...
test('VCarousel.js', ({ mount }) => {
  it.skip('should render component and match snapshot', async () => {
  ...
  it.skip('should render component with image cycling off and match snapshot', async () => {
    const wrapper = mount(VCarousel, {
      propsData: {
        cycle: false
      }
  ...
  it.skip('should render component with custom icon and match snapshot', async () => {
  ...
  it.skip('should render component with custom duration between image cycles and match snapshot', async () => {
    const wrapper = mount(VCarousel, {
      propsData: {
        interval: 1000
      }
  ...
  it.skip('should render component with custom prev icon and match snapshot', async () => {
    const wrapper = mount(VCarousel, {
      propsData: {
        prevIcon: 'stop'
      }
  ...
  it.skip('should render component without prev icon and match snapshot', async () => {
    const wrapper = mount(VCarousel, {
      propsData: {
        prevIcon: false
      }
  ...
  it.skip('should render component with custom next icon and match snapshot', async () => {
    const wrapper = mount(VCarousel, {
      propsData: {
        nextIcon: 'stop'
      }
  ...
  it.skip('should render component without delimiters', async () => {
  ...
  it.skip('should render component without controls', async () => {
  ...
  it.skip('should change item on swipe', async () => {
  ...
  it.skip('should change item on controls click', async () => {
    const wrapper = mount(create())
    await wrapper.vm.$nextTick()
